...
object MainController {
    ...
    private fun update(ip: String, user: String, pass: String) {
        val stringRequest = object: StringRequest(
                Method.GET, ip,
                { response -> metricsData = stringifyReturn(MSIParser.parseMSIData(response, "UTF-8"))}, // TODO: Make encoding more dynamic.
                { error -> metricsData = "That didn't work! - ${error.toString()} -\n" })
        {
